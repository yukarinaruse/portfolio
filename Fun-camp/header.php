	...
	<ul class="ddmenu f-right">
		...
		<li>カテゴリー
			<ul>
				<li>道具
					<ul>
						<li><a href="page.php">テント・タープ</a></li>
						<li><a href="#">寝具</a></li>
						<li><a href="#">ランタン・ライト</a></li>
						<li><a href="#">クッカー</a></li>
						<li><a href="#">テーブル</a></li>
						<li><a href="#">ＤＩＹ</a></li>
						<li><a href="#">etc...</a></li>
			...
			<ul>
				<li><a href="https://www.nap-camp.com/">なっぷ</a></li>
				<li><a href="https://camphack.nap-camp.com/campsite#/">キャンプハック</a></li>
			</ul>
		</li></ul>
</header> 